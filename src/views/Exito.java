...
public class Exito extends JDialog {
	...
	public Exito() {
		...
		}
		{
			...
			lblNewLabel_1.setBounds(27, 116, 341, 27);
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 11));
			...
			}
			{
				...
				cancelButton.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 11));
