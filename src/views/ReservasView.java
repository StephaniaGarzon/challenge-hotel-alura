...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblNewLabel_3.setBounds(82, 332, 17, 25);
		lblNewLabel_3.setForeground(SystemColor.textHighlight);
		lblNewLabel_3.setFont(new Font("Segoe UI Semibold", Font.BOLD, 17));
		...
		lblCheckOut.setBounds(68, 221, 244, 14);
		...
		txtValor.setBounds(101, 328, 85, 33);
		txtValor.setEditable(false);
		txtValor.setFont(new Font("Segoe UI Semibold", Font.BOLD, 17));
		...
		txtFormaPago.setFont(new Font("Segoe UI Semilight", Font.PLAIN, 16));
		...
		lblFormaPago.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 17));
		panel.add(lblFormaPago);
		
		JLabel lblTitulo = new JLabel("SISTEMA DE RESERVAS");
		lblTitulo.setHorizontalAlignment(SwingConstants.CENTER);
		lblTitulo.setBounds(96, 60, 244, 42);
		...
		lblSiguiente.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 18));
