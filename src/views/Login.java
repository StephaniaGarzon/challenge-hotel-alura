...
public class Login extends JFrame {
	...
	public Login() {
		...
		txtUsuario.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 16));
		...
		labelTitulo.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 26));
		labelTitulo.setBounds(65, 149, 222, 32);
		...
		txtContrasena.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 16));
		...
		LabelUsuario.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 20));
		LabelUsuario.setBounds(65, 219, 107, 26);
		panel.add(LabelUsuario);
		
		JLabel lblContrasea = new JLabel("CONTRASEÑA");
		lblContrasea.setForeground(SystemColor.textInactiveText);
		lblContrasea.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 20));
		...
		lblNewLabel_1.setBounds(65, 65, 61, 64);
