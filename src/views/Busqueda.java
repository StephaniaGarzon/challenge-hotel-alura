...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		lblTitulo.setBounds(331, 62, 296, 42);
		...
		panel.setFont(new Font("Segoe UI Historic", Font.PLAIN, 16));
		...
		tbHuespedes.setFont(new Font("Segoe UI Historic", Font.PLAIN, 16));
		...
		modeloHuesped.addRow(new Object[] { "ID", "NOMBRE", "APELLIDO", "FECHA DE NACIMIENTO", "NACIONALIDAD", "TELEFONO",
		"ID RESERVA" });
		...
		tbReservas.setFont(new Font("Segoe UI Historic", Font.PLAIN, 16));
		...
		lblBuscar.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 18));
		...
		lblEditar.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 18));
		...
		lblEliminar.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 18));
