...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Stephania Garzón B. © 2022");
		lblCopyR.setHorizontalAlignment(SwingConstants.CENTER);
		lblCopyR.setBounds(315, 11, 345, 19);
		lblCopyR.setForeground(new Color(240, 248, 255));
		lblCopyR.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 16));
