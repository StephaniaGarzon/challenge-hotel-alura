...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		labelRegistro.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 18));
		...
		lblBusquedaDeReservas.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 18));
		...
		labelExit.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 18));
	    ...
	    labelFecha.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 32));
	    ...
	    lblBienvenido.setFont(new Font("Segoe UI Semibold", Font.BOLD, 24));
	    ...
	    labelDescripcion.setFont(new Font("Segoe UI Historic", Font.PLAIN, 17));
	    ...
	    labelDescripcion_1.setFont(new Font("Segoe UI Historic", Font.PLAIN, 17));
	    ...
	    lblDescripcion_3.setFont(new Font("Segoe UI Historic", Font.PLAIN, 17));
	    ...
	    lblDescripcion_4.setFont(new Font("Segoe UI Historic", Font.PLAIN, 17));
	    ...
	    lblDescripcion_5.setFont(new Font("Segoe UI Historic", Font.PLAIN, 17));
